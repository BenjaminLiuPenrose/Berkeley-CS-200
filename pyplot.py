...
# This tutorial is adapted from https://matplotlib.org/users/pyplot_tutorial.html
...
# the `data` keyword argument (see [`plt.scatter` reference](https://matplotlib.org/api/_as_gen/matplotlib.pyplot.scatter.html)). If provided, then you may generate plots with
...
# coordinates.  See `/gallery/subplots_axes_and_figures/axes_demo` for an example of
# placing axes manually and `/gallery/subplots_axes_and_figures/subplot_demo` for an
...
# instead (see `/tutorials/intermediate/artists`)
# 
...
# 
# These properties are covered in more detail in `/tutorials/text/text_props`.
# 
# 
...
# postscript -- see `/tutorials/text/usetex`.
# 
# 
# Annotating text
# ---------------
